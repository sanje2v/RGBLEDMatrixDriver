/*!
 * @file Adafruit_NeoPixel_Unmanagedbuf.cpp
 *
 ...
 *
 * This file is part of the Adafruit_NeoPixel_Unmanagedbuf library.
 *
 * Adafruit_NeoPixel_Unmanagedbuf is free software: you can redistribute it and/or
 * modify it under the terms of the GNU Lesser General Public License as
 * published by the Free Software Foundation, either version 3 of the
 * License, or (at your option) any later version.
 *
 * Adafruit_NeoPixel_Unmanagedbuf is distributed in the hope that it will be useful,
...
/*!
  ...
  @param   t  Pixel type -- add together NEO_* constants defined in
              Adafruit_NeoPixel_Unmanagedbuf.h, for example NEO_GRB+NEO_KHZ800 for
...
*/
void Adafruit_NeoPixel_Unmanagedbuf::begin(void) {
  if(pin >= 0) {
    pinMode(pin, OUTPUT);
...
/*!
  @brief   Change the length of a previously-declared Adafruit_NeoPixel_Unmanagedbuf
...
/*!
  @brief   Change the pixel format of a previously-declared
           Adafruit_NeoPixel_Unmanagedbuf strip object. If format changes from one of
  ...
  @note    This function is deprecated, here only for old projects that
           ...
           (length, pin, type).
*/
void Adafruit_NeoPixel_Unmanagedbuf::updateType(neoPixelType t) {
...
*/
void Adafruit_NeoPixel_Unmanagedbuf::show(void) {
...
*/
void Adafruit_NeoPixel_Unmanagedbuf::setPin(uint16_t p) {
...
*/
void Adafruit_NeoPixel_Unmanagedbuf::setPixelColor(
...
*/
void Adafruit_NeoPixel_Unmanagedbuf::setPixelColor(uint16_t n, uint32_t c) {
  if(n < numLEDs) {
    uint8_t *p,
      r = (uint8_t)(c >> 16),
      g = (uint8_t)(c >>  8),
...
*/
void Adafruit_NeoPixel_Unmanagedbuf::fill(uint32_t c, uint16_t first, uint16_t count) {
  uint16_t i, end;
...
*/
uint32_t Adafruit_NeoPixel_Unmanagedbuf::ColorHSV(uint16_t hue, uint8_t sat, uint8_t val) {
...
*/
uint32_t Adafruit_NeoPixel_Unmanagedbuf::getPixelColor(uint16_t n) const {
...
*/
void Adafruit_NeoPixel_Unmanagedbuf::setBrightness(uint8_t b) {
...
*/
uint8_t Adafruit_NeoPixel_Unmanagedbuf::getBrightness(void) const {
  return brightness - 1;
}
...
*/
void Adafruit_NeoPixel_Unmanagedbuf::clear(void) {
  memset(pixels, 0, numBytes);
}

// A 32-bit variant of gamma8() that applies the same function
// to all components of a packed RGB or WRGB value.
uint32_t Adafruit_NeoPixel_Unmanagedbuf::gamma32(uint32_t x) {
  uint8_t *y = (uint8_t *)&x;
