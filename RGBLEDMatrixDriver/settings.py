...
NUM_ROWS_IN_ONE_LEDMATRIX = TOTAL_LEDMATRIX_ROWS // NUM_LEDMATRICES
DEFAULT_FRAME_INTERVAL_MS = 200
from utils import ROW_COLOR_OFF_BYTE, ROW_COLOR_ON_BYTE
DEFAULT_FRAMES =\
[[ROW_COLOR_ON_BYTE, ROW_COLOR_ON_BYTE, ROW_COLOR_ON_BYTE]*TOTAL_LEDMATRIX_ROWS,
 [ROW_COLOR_ON_BYTE, ROW_COLOR_ON_BYTE, ROW_COLOR_OFF_BYTE]*TOTAL_LEDMATRIX_ROWS,
 [ROW_COLOR_ON_BYTE, ROW_COLOR_OFF_BYTE, ROW_COLOR_OFF_BYTE]*TOTAL_LEDMATRIX_ROWS,
 [ROW_COLOR_OFF_BYTE, ROW_COLOR_OFF_BYTE, ROW_COLOR_OFF_BYTE]*TOTAL_LEDMATRIX_ROWS,
 [ROW_COLOR_OFF_BYTE, ROW_COLOR_OFF_BYTE, ROW_COLOR_ON_BYTE]*TOTAL_LEDMATRIX_ROWS,
 [ROW_COLOR_OFF_BYTE, ROW_COLOR_ON_BYTE, ROW_COLOR_ON_BYTE]*TOTAL_LEDMATRIX_ROWS,
 [ROW_COLOR_OFF_BYTE, ROW_COLOR_ON_BYTE, ROW_COLOR_OFF_BYTE]*TOTAL_LEDMATRIX_ROWS,
 [ROW_COLOR_ON_BYTE, ROW_COLOR_OFF_BYTE, ROW_COLOR_ON_BYTE]*TOTAL_LEDMATRIX_ROWS]
